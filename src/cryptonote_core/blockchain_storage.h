...
namespace cryptonote {
  ...
  private:
    ...
    bool validate_miner_transaction(const block& b, size_t cumulative_block_size, uint64_t fee, uint64_t& base_reward, uint64_t already_generated_coins, const difficulty_type diff);
