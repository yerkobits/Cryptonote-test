...
#define CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX         0x13aa79
...
#define CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE       40000 //size of block (bytes) after which reward for block calculated using block size
...
#define P2P_DEFAULT_PORT                                27854
//TODO This port will be used by the daemon to interact with simlewallet
#define RPC_DEFAULT_PORT                                27855
